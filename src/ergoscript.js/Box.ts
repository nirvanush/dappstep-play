...
export class Box {
  ...
  private _serializeRegisters(): AdditionalRegisters {
    let additionalRegisters: AdditionalRegisters = {};

    if (this.R4.register) { additionalRegisters.R4 = this.R4.register }
    if (this.R5.register) { additionalRegisters.R5 = this.R5.register }
    if (this.R6.register) { additionalRegisters.R6 = this.R6.register }
    if (this.R7.register) { additionalRegisters.R7 = this.R7.register }
    if (this.R8.register) { additionalRegisters.R8 = this.R8.register }
    if (this.R9.register) { additionalRegisters.R9 = this.R9.register }
