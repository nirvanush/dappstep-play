...
type TxConfig = {
  ...
  additionalRegisters: {
    R4?: RegisterInput; R5?: RegisterInput; R6?: RegisterInput; R7?: RegisterInput; R8?: RegisterInput; R9?: RegisterInput;
  };
}
...
export default class Transaction {
  ...
  async get_utxos(amount: string, tokenId: string) {
    return ergo.get_utxos(amount, tokenId)
  }

  async loadTokensFromWallet() {
